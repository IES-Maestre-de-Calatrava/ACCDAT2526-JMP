...
public class Empleado implements Serializable, Comparable<Empleado>{
    ...
    public String toString (){
        String mensaje="El empleado se llama "+nombre+" "+apellido+" con "+edad+" años " +
                "y un salario de "+salario+" Pertenece al departamento de "+departamento.nombre;
    ...
    public Empleado(String nombre, String apellido, int edad, double salario, Departamento departamento) {
        this.nombre = nombre;
        this.apellido = apellido;
        this.edad = edad;
        this.salario = salario;
