...
public class VentanaConversorTexto implements InterfazVista {
    ...
    public void realizarOperacion() throws IOException, TransformerException{
        ...
        switch(operacion){
            case 1 -> controlador.ActionPerformed(new ActionEvent(this, operacion, CORRECCION_EXAMENES));
            case 2 -> controlador.ActionPerformed(new ActionEvent(this, operacion, RECLAMACION));
            case 3 -> controlador.ActionPerformed(new ActionEvent(this, operacion, CREAR_ARBOLDOM));
            case 4 -> controlador.ActionPerformed(new ActionEvent(this, operacion, COVERTIR_A_HMTL));
            case 5 -> controlador.ActionPerformed(new ActionEvent(this, operacion, COPIA_SEGURIDAD));
